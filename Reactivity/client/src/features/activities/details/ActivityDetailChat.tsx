...
const ActivityDetailsChat = observer( function ActivityDetailsChat() {
                    ...
                    <div>
                        <form>
                            <TextField
                                ...
                                multiline
                                rows={2}
                                placeholder="Napisz komentarz...( ENTER + SHIFT - przejdź do nowej linii"
  ...
  console.log("Comment UTC:", comment.createAt);
  console.log("Local interpretation:", new Date(comment.createAt).toLocaleString());
